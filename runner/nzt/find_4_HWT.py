...
target_date = datetime(2023, 9, 4)
shots = ["i10"]#, "i20", "n80", "n90", "m90", "n40", "g20"]
json_file = "W:/projects/nzt/misc/users/yangtao/output/HWT_test.json"
text_file = "W:/projects/nzt/misc/users/yangtao/output/HWT_test.txt"


def get_time_shot_files():
    shots_files = {}
    for s in shots:
        max_files = project_files.get_w_files("nzt", s, ["efx"])
